...
// Sign in, sign up and the password pages sit inside the shop's header and footer,
// like every other storefront page. Marketing tags stay off here, as before.
    ...
    return (
        <>
            ...
            <main className="pb-[58px] sm:pb-0">
                <div className="relative flex flex-col items-center justify-center overflow-hidden bg-slate-50 px-4 py-12 sm:py-16">
