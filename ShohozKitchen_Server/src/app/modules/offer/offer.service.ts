...
const PRODUCT_FIELDS =
    'name slug price originalPrice discount images thumbnail rating reviewCount totalSold stock approvalStatus visibility';
    ...
    async getActive(type?: string) {
        ...
        const offers = await Offer.find(query)
            ...
            .populate({
                ...
                match: { approvalStatus: { $ne: 'rejected' }, visibility: { $ne: 'hidden' } },
            });
