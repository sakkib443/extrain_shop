    ...
    async get() {
        ...
        if (!content) {
            content = await SiteContent.create({
                ...
                // The business line is seeded so a fresh install can be called and
                // messaged straight away; everything else starts empty and the
                // storefront hides it until an admin fills it in under Site Content.
                contact: {
                    phone: '01711946614',
                    phones: [],
                ...
                footer: {
                    companyName: 'Trendy Shops',
                    copyright: '',
                    links: [],
                },
                defaultTagline: 'Your trusted online marketplace',
                seo: {
                    title: 'Trendy Shops - Your trusted online marketplace',
                    description: 'Shop the latest products with amazing deals at Trendy Shops. Premium quality products at best prices.',
                    keywords: 'trendy shops, trendyshops, ecommerce, online shopping, best deals, products, shop',
                },
                announcement: {
                    message: '',
                    bgColor: '#E4525C',
